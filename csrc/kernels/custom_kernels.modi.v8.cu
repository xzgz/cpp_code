...
__global__ void __launch_bounds__(WvPrGrp* THRDS)
  ...
  #pragma unroll
          for (uint32_t n = 0; n < N; n++) {
            ...
            if constexpr (YTILE >= 5)
              acc2[4] = __hmul2_fp32(*((scalar2_t*)(&(bigA[n][k2].f[0]))), *((scalar2_t*)(&(bigB[4][k2].f[0]))));
            if constexpr (YTILE >= 6)
              acc2[5] = __hmul2_fp32(*((scalar2_t*)(&(bigA[n][k2].f[0]))), *((scalar2_t*)(&(bigB[5][k2].f[0]))));
            if constexpr (YTILE >= 7)
              acc2[6] = __hmul2_fp32(*((scalar2_t*)(&(bigA[n][k2].f[0]))), *((scalar2_t*)(&(bigB[6][k2].f[0]))));
            if constexpr (YTILE >= 8)
              acc2[7] = __hmul2_fp32(*((scalar2_t*)(&(bigA[n][k2].f[0]))), *((scalar2_t*)(&(bigB[7][k2].f[0]))));
  ...
  #pragma unroll
            for (uint32_t b = 1; b < A_CHUNK / 2; b++) {
              ...
              if constexpr (YTILE >= 5)
                acc2[4] =
                    __hfma2_fp32(*((scalar2_t*)(&(bigA[n][k2].f[b]))), *((scalar2_t*)(&(bigB[4][k2].f[b]))), acc2[4]);
              if constexpr (YTILE >= 6)
                acc2[5] =
                    __hfma2_fp32(*((scalar2_t*)(&(bigA[n][k2].f[b]))), *((scalar2_t*)(&(bigB[5][k2].f[b]))), acc2[5]);
              if constexpr (YTILE >= 7)
                acc2[6] =
                    __hfma2_fp32(*((scalar2_t*)(&(bigA[n][k2].f[b]))), *((scalar2_t*)(&(bigB[6][k2].f[b]))), acc2[6]);
              if constexpr (YTILE >= 8)
                acc2[7] =
                    __hfma2_fp32(*((scalar2_t*)(&(bigA[n][k2].f[b]))), *((scalar2_t*)(&(bigB[7][k2].f[b]))), acc2[7]);
            }
  #pragma unroll
            for (uint32_t i = 0; i < YTILE; ++i) {
              sum[n][i] += acc2[i].x + acc2[i].y;
            }
            // sum[n][0] += acc2[0].x + acc2[0].y;
          }
        } else {
  #pragma unroll
          for (uint32_t n = 0; n < N; n++) {
