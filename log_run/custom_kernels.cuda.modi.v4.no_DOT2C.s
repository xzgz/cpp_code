...
; %bb.8:
	...
	v_mad_u64_u32 v[4:5], s[6:7], s2, 3, v[0:1]
...
; %bb.15:                               ;   in Loop: Header=BB1_13 Depth=2
	...
	;;#ASMEND
	v_cmp_gt_u32_e64 s[10:11], s2, v12
...
; %bb.16:                               ;   in Loop: Header=BB1_13 Depth=2
	...
	v_cmp_gt_u32_e64 s[10:11], s2, v14
	s_and_b64 exec, exec, s[10:11]
	s_cbranch_execz .LBB1_18
; %bb.17:                               ;   in Loop: Header=BB1_13 Depth=2
	v_add_u32_e32 v8, 0x600, v8
	v_lshl_add_u64 v[14:15], v[8:9], 1, s[4:5]
	;;#ASMSTART
	global_load_dwordx4 v[14:17], v[14:15], off nt
...
.LBB1_18:                               ;   in Loop: Header=BB1_13 Depth=2
	...
	v_add_u32_e32 v14, s20, v1
	v_lshlrev_b32_e32 v18, 1, v14
	v_add_u32_e32 v15, s20, v4
...
; %bb.19:                               ;   in Loop: Header=BB1_13 Depth=2
	...
	v_lshl_add_u32 v16, v8, 1, v7
	v_lshl_add_u32 v17, v14, 1, v7
	v_lshl_add_u32 v18, v15, 1, v7
	;;#ASMSTART
...
; %bb.20:                               ;   in Loop: Header=BB1_13 Depth=2
	...
	v_lshl_add_u32 v16, v8, 1, v10
	v_lshl_add_u32 v17, v14, 1, v10
	v_lshl_add_u32 v18, v15, 1, v10
	;;#ASMSTART
	ds_read_b128 v[16:19], v13
	ds_read_b128 v[20:23], v16
	ds_read_b128 v[24:27], v17
	...
	;;#ASMEND
	v_add_u32_e32 v13, 0x600, v3
	v_cmp_gt_u32_e64 s[10:11], s2, v13
	s_and_b64 exec, exec, s[10:11]
	s_cbranch_execz .LBB1_22
; %bb.21:                               ;   in Loop: Header=BB1_13 Depth=2
	v_lshlrev_b32_e32 v13, 1, v13
	v_lshl_add_u32 v8, v8, 1, v11
...
.LBB1_26:                               ;   in Loop: Header=BB1_10 Depth=1
	...
	;;#ASMSTART
	s_nop 0
	v_add_f32 v3, v9, v9 row_shr:8 bound_ctrl:0 
	;;#ASMEND
	s_nop 0
	;;#ASMSTART
	s_nop 0
...
; %bb.27:                               ;   in Loop: Header=BB1_10 Depth=1
	...
	v_lshl_add_u64 v[12:13], v[2:3], 1, s[8:9]
...
.LBB2_27:                               ;   in Loop: Header=BB2_11 Depth=1
	...
	;;#ASMSTART
	s_nop 0
	v_add_f32 v12, v9, v9 row_shr:8 bound_ctrl:0 
	;;#ASMEND
	s_nop 0
	;;#ASMSTART
	s_nop 0
...
; %bb.31:                               ;   in Loop: Header=BB2_11 Depth=1
	...
	v_cmp_eq_u32_sdwa s[10:11], v12, v9 src0_sel:WORD_0 src1_sel:DWORD
	s_nop 1
	v_cndmask_b32_e64 v8, v3, v12, s[10:11]
...
; %bb.36:                               ;   in Loop: Header=BB2_11 Depth=1
	s_or_b64 exec, exec, s[16:17]
	v_add_u32_e32 v8, s3, v2
	v_lshl_add_u64 v[14:15], v[8:9], 1, s[8:9]
...
; COMPUTE_PGM_RSRC3_GFX90A:TG_SPLIT: 0
	...
	.type	__hip_cuid_9cdca1900926cb09,@object ; @__hip_cuid_9cdca1900926cb09
	.section	.bss,"aw",@nobits
	.globl	__hip_cuid_9cdca1900926cb09
__hip_cuid_9cdca1900926cb09:
	.byte	0                               ; 0x0
	.size	__hip_cuid_9cdca1900926cb09, 1
	...
	.addrsig
	.addrsig_sym __hip_cuid_9cdca1900926cb09
	.amdgpu_metadata
---
amdhsa.kernels:
  - .agpr_count:     0
