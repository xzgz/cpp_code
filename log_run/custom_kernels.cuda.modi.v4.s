...
; %bb.8:
	...
	v_mad_u64_u32 v[84:85], s[6:7], s2, 3, v[80:81]
	v_add_u32_e32 v85, s2, v80
	v_mad_u64_u32 v[86:87], s[6:7], s2, v82, v[80:81]
...
.LBB1_19:                               ;   in Loop: Header=BB1_16 Depth=2
	v_add_u32_e32 v88, s24, v86
	v_lshl_add_u64 v[76:77], v[88:89], 1, s[4:5]
	;;#ASMSTART
...
; %bb.20:                               ;   in Loop: Header=BB1_16 Depth=2
	...
	v_cmp_gt_u32_e64 s[10:11], s2, v97
	s_and_saveexec_b64 s[18:19], s[10:11]
	s_cbranch_execz .LBB1_24
; %bb.21:                               ;   in Loop: Header=BB1_16 Depth=2
	v_add_u32_e32 v64, 0x400, v88
	...
	;;#ASMEND
	v_add_u32_e32 v97, 0x600, v95
	v_cmp_gt_u32_e64 s[10:11], s2, v97
	s_and_saveexec_b64 s[20:21], s[10:11]
	s_cbranch_execz .LBB1_23
; %bb.22:                               ;   in Loop: Header=BB1_16 Depth=2
	v_add_u32_e32 v88, 0x600, v88
	v_lshl_add_u64 v[60:61], v[88:89], 1, s[4:5]
	;;#ASMSTART
	global_load_dwordx4 v[60:63], v[60:61], off nt
...
.LBB1_26:                               ;   in Loop: Header=BB1_16 Depth=2
	...
	v_add_u32_e32 v88, s24, v85
	v_lshlrev_b32_e32 v21, 1, v88
	v_add_u32_e32 v97, s24, v81
	v_lshlrev_b32_e32 v22, 1, v97
	v_add_u32_e32 v98, s24, v84
	v_lshlrev_b32_e32 v23, 1, v98
	;;#ASMSTART
	ds_read_b128 v[72:75], v20
	ds_read_b128 v[52:55], v21
	ds_read_b128 v[36:39], v22
	ds_read_b128 v[20:23], v23
...
; %bb.27:                               ;   in Loop: Header=BB1_16 Depth=2
	...
	v_lshl_add_u32 v9, v88, 1, v87
	v_lshl_add_u32 v10, v97, 1, v87
	v_lshl_add_u32 v11, v98, 1, v87
	;;#ASMSTART
	...
	v_cmp_gt_u32_e64 s[10:11], s2, v99
	s_and_saveexec_b64 s[18:19], s[10:11]
	s_cbranch_execz .LBB1_31
; %bb.28:                               ;   in Loop: Header=BB1_16 Depth=2
	v_lshlrev_b32_e32 v4, 1, v99
	v_lshl_add_u32 v5, v88, 1, v90
	v_lshl_add_u32 v6, v97, 1, v90
	v_lshl_add_u32 v7, v98, 1, v90
	;;#ASMSTART
	...
	;;#ASMEND
	v_add_u32_e32 v99, 0x600, v95
	v_cmp_gt_u32_e64 s[10:11], s2, v99
	s_and_saveexec_b64 s[20:21], s[10:11]
	s_cbranch_execz .LBB1_30
; %bb.29:                               ;   in Loop: Header=BB1_16 Depth=2
	v_lshlrev_b32_e32 v0, 1, v99
	v_lshl_add_u32 v1, v88, 1, v91
	v_lshl_add_u32 v2, v97, 1, v91
	v_lshl_add_u32 v3, v98, 1, v91
	;;#ASMSTART
...
.LBB1_33:                               ;   in Loop: Header=BB1_16 Depth=2
	...
	;;#ASMEND
	;;#ASMSTART
	v_dot2c_f32_f16 v83, v72, v76
	;;#ASMEND
	s_nop 0
	;;#ASMSTART
	v_dot2c_f32_f16 v83, v73, v77
	;;#ASMEND
	s_nop 0
	;;#ASMSTART
	v_dot2c_f32_f16 v83, v74, v78
	;;#ASMEND
	s_nop 0
	;;#ASMSTART
	v_dot2c_f32_f16 v83, v75, v79
	;;#ASMEND
	;;#ASMSTART
	...
	;;#ASMEND
	;;#ASMSTART
	v_dot2c_f32_f16 v93, v36, v76
	;;#ASMEND
	s_nop 0
	;;#ASMSTART
	v_dot2c_f32_f16 v93, v37, v77
	;;#ASMEND
	s_nop 0
	;;#ASMSTART
	v_dot2c_f32_f16 v93, v38, v78
	;;#ASMEND
	s_nop 0
	;;#ASMSTART
	v_dot2c_f32_f16 v93, v39, v79
	;;#ASMEND
	;;#ASMSTART
	v_dot2c_f32_f16 v92, v20, v76
	;;#ASMEND
	s_nop 0
	;;#ASMSTART
	v_dot2c_f32_f16 v92, v21, v77
	;;#ASMEND
	s_nop 0
	;;#ASMSTART
	v_dot2c_f32_f16 v92, v22, v78
	;;#ASMEND
	s_nop 0
	;;#ASMSTART
	v_dot2c_f32_f16 v92, v23, v79
	;;#ASMEND
...
; %bb.34:                               ;   in Loop: Header=BB1_16 Depth=2
	...
	;;#ASMEND
	;;#ASMSTART
	v_dot2c_f32_f16 v83, v56, v68
	;;#ASMEND
	s_nop 0
	;;#ASMSTART
	v_dot2c_f32_f16 v83, v57, v69
	;;#ASMEND
	s_nop 0
	;;#ASMSTART
	v_dot2c_f32_f16 v83, v58, v70
	;;#ASMEND
	s_nop 0
	;;#ASMSTART
	v_dot2c_f32_f16 v83, v59, v71
	;;#ASMEND
	;;#ASMSTART
	v_dot2c_f32_f16 v94, v40, v68
	;;#ASMEND
	s_nop 0
	;;#ASMSTART
	v_dot2c_f32_f16 v94, v41, v69
	;;#ASMEND
	s_nop 0
	;;#ASMSTART
	v_dot2c_f32_f16 v94, v42, v70
	;;#ASMEND
	s_nop 0
	;;#ASMSTART
	v_dot2c_f32_f16 v94, v43, v71
	;;#ASMEND
	;;#ASMSTART
	v_dot2c_f32_f16 v93, v24, v68
	;;#ASMEND
	s_nop 0
	;;#ASMSTART
	v_dot2c_f32_f16 v93, v25, v69
	;;#ASMEND
	s_nop 0
	;;#ASMSTART
	v_dot2c_f32_f16 v93, v26, v70
	;;#ASMEND
	s_nop 0
	;;#ASMSTART
	v_dot2c_f32_f16 v93, v27, v71
	;;#ASMEND
	;;#ASMSTART
	v_dot2c_f32_f16 v92, v8, v68
	;;#ASMEND
	s_nop 0
	;;#ASMSTART
	v_dot2c_f32_f16 v92, v9, v69
	;;#ASMEND
	s_nop 0
	;;#ASMSTART
	v_dot2c_f32_f16 v92, v10, v70
	;;#ASMEND
	s_nop 0
	;;#ASMSTART
	v_dot2c_f32_f16 v92, v11, v71
	;;#ASMEND
...
; %bb.35:                               ;   in Loop: Header=BB1_16 Depth=2
	...
	;;#ASMEND
	;;#ASMSTART
	v_dot2c_f32_f16 v83, v48, v64
	;;#ASMEND
	s_nop 0
	;;#ASMSTART
	v_dot2c_f32_f16 v83, v49, v65
	;;#ASMEND
	s_nop 0
	;;#ASMSTART
	v_dot2c_f32_f16 v83, v50, v66
	;;#ASMEND
	s_nop 0
	;;#ASMSTART
	v_dot2c_f32_f16 v83, v51, v67
	;;#ASMEND
	;;#ASMSTART
	v_dot2c_f32_f16 v94, v32, v64
	;;#ASMEND
	s_nop 0
	;;#ASMSTART
	v_dot2c_f32_f16 v94, v33, v65
	;;#ASMEND
	s_nop 0
	;;#ASMSTART
	v_dot2c_f32_f16 v94, v34, v66
	;;#ASMEND
	s_nop 0
	;;#ASMSTART
	v_dot2c_f32_f16 v94, v35, v67
	;;#ASMEND
	;;#ASMSTART
	v_dot2c_f32_f16 v93, v16, v64
	;;#ASMEND
	s_nop 0
	;;#ASMSTART
	v_dot2c_f32_f16 v93, v17, v65
	;;#ASMEND
	s_nop 0
	;;#ASMSTART
	v_dot2c_f32_f16 v93, v18, v66
	;;#ASMEND
	s_nop 0
	;;#ASMSTART
	v_dot2c_f32_f16 v93, v19, v67
	;;#ASMEND
	;;#ASMSTART
	v_dot2c_f32_f16 v92, v4, v64
	;;#ASMEND
	s_nop 0
	;;#ASMSTART
	v_dot2c_f32_f16 v92, v5, v65
	;;#ASMEND
	s_nop 0
	;;#ASMSTART
	v_dot2c_f32_f16 v92, v6, v66
	;;#ASMEND
	s_nop 0
	;;#ASMSTART
	v_dot2c_f32_f16 v92, v7, v67
	;;#ASMEND
...
; %bb.36:                               ;   in Loop: Header=BB1_16 Depth=2
	...
	;;#ASMEND
	;;#ASMSTART
	v_dot2c_f32_f16 v94, v28, v60
	;;#ASMEND
	s_nop 0
	;;#ASMSTART
	v_dot2c_f32_f16 v94, v29, v61
	;;#ASMEND
	s_nop 0
	;;#ASMSTART
	v_dot2c_f32_f16 v94, v30, v62
	;;#ASMEND
	s_nop 0
	;;#ASMSTART
	v_dot2c_f32_f16 v94, v31, v63
	;;#ASMEND
	;;#ASMSTART
	v_dot2c_f32_f16 v93, v12, v60
	;;#ASMEND
	s_nop 0
	;;#ASMSTART
	v_dot2c_f32_f16 v93, v13, v61
	;;#ASMEND
	s_nop 0
	;;#ASMSTART
	v_dot2c_f32_f16 v93, v14, v62
	;;#ASMEND
	s_nop 0
	;;#ASMSTART
	v_dot2c_f32_f16 v93, v15, v63
	;;#ASMEND
	;;#ASMSTART
	v_dot2c_f32_f16 v92, v0, v60
	;;#ASMEND
	s_nop 0
	;;#ASMSTART
	v_dot2c_f32_f16 v92, v1, v61
	;;#ASMEND
	s_nop 0
	;;#ASMSTART
	v_dot2c_f32_f16 v92, v2, v62
	;;#ASMEND
	s_nop 0
	;;#ASMSTART
	v_dot2c_f32_f16 v92, v3, v63
	;;#ASMEND
	s_branch .LBB1_12
...
.LBB2_27:                               ;   in Loop: Header=BB2_17 Depth=2
	v_lshlrev_b32_e32 v20, 1, v83
	v_add_u32_e32 v88, s26, v85
	v_lshlrev_b32_e32 v21, 1, v88
	v_add_u32_e32 v97, s26, v81
	v_lshlrev_b32_e32 v22, 1, v97
	v_add_u32_e32 v98, s26, v84
	v_lshlrev_b32_e32 v23, 1, v98
	;;#ASMSTART
	ds_read_b128 v[72:75], v20
	ds_read_b128 v[52:55], v21
...
; %bb.28:                               ;   in Loop: Header=BB2_17 Depth=2
	...
	;;#ASMEND
	v_add_u32_e32 v99, 0x400, v83
	v_cmp_gt_u32_e64 s[10:11], s2, v99
	s_and_saveexec_b64 s[18:19], s[10:11]
	s_cbranch_execz .LBB2_32
; %bb.29:                               ;   in Loop: Header=BB2_17 Depth=2
	v_lshlrev_b32_e32 v4, 1, v99
	v_lshl_add_u32 v5, v88, 1, v94
	v_lshl_add_u32 v6, v97, 1, v94
	v_lshl_add_u32 v7, v98, 1, v94
	;;#ASMSTART
	ds_read_b128 v[48:51], v4
	ds_read_b128 v[32:35], v5
	ds_read_b128 v[16:19], v6
	...
	;;#ASMEND
	v_add_u32_e32 v99, 0x600, v83
	v_cmp_gt_u32_e64 s[10:11], s2, v99
	s_and_saveexec_b64 s[20:21], s[10:11]
	s_cbranch_execz .LBB2_31
; %bb.30:                               ;   in Loop: Header=BB2_17 Depth=2
	v_lshlrev_b32_e32 v0, 1, v99
	v_lshl_add_u32 v1, v88, 1, v95
	v_lshl_add_u32 v2, v97, 1, v95
	v_lshl_add_u32 v3, v98, 1, v95
	;;#ASMSTART
	ds_read_b128 v[44:47], v0
	ds_read_b128 v[28:31], v1
	ds_read_b128 v[12:15], v2
...
.LBB2_34:                               ;   in Loop: Header=BB2_17 Depth=2
	...
	v_and_b32_e32 v107, 0xffff0000, v74
	...
	v_pk_mul_f32 v[114:115], v[114:115], v[100:101]
	v_and_b32_e32 v117, 0xffff0000, v53
	v_lshlrev_b32_e32 v116, 16, v53
	v_pk_mul_f32 v[116:117], v[116:117], v[104:105]
	v_and_b32_e32 v119, 0xffff0000, v54
	v_lshlrev_b32_e32 v118, 16, v54
	v_pk_mul_f32 v[118:119], v[118:119], v[108:109]
	...
	s_nop 0
	v_pk_add_f32 v[92:93], v[92:93], v[98:99]
	v_and_b32_e32 v99, 0xffff0000, v36
...
; %bb.35:                               ;   in Loop: Header=BB2_17 Depth=2
	...
	v_and_b32_e32 v99, 0xffff0000, v68
	v_lshlrev_b32_e32 v98, 16, v68
	...
	v_and_b32_e32 v107, 0xffff0000, v70
	...
	v_and_b32_e32 v111, 0xffff0000, v71
	v_lshlrev_b32_e32 v110, 16, v71
	v_pk_mul_f32 v[108:109], v[108:109], v[110:111]
	v_and_b32_e32 v113, 0xffff0000, v40
	v_lshlrev_b32_e32 v112, 16, v40
	v_pk_mul_f32 v[112:113], v[112:113], v[98:99]
	v_and_b32_e32 v115, 0xffff0000, v41
	v_lshlrev_b32_e32 v114, 16, v41
	v_pk_mul_f32 v[114:115], v[114:115], v[102:103]
	...
	v_pk_add_f32 v[96:97], v[100:101], v[104:105]
	v_and_b32_e32 v101, 0xffff0000, v43
	v_lshlrev_b32_e32 v100, 16, v43
	v_pk_mul_f32 v[100:101], v[100:101], v[110:111]
	v_pk_add_f32 v[92:93], v[92:93], v[96:97]
	...
	v_pk_mul_f32 v[96:97], v[96:97], v[98:99]
	v_and_b32_e32 v101, 0xffff0000, v25
	...
	v_pk_mul_f32 v[98:99], v[112:113], v[98:99]
	...
	v_mov_b32_e32 v104, v97
	v_pk_add_f32 v[96:97], v[98:99], v[104:105]
...
; %bb.36:                               ;   in Loop: Header=BB2_17 Depth=2
	...
	v_pk_mul_f32 v[96:97], v[96:97], v[98:99]
	v_and_b32_e32 v101, 0xffff0000, v49
	v_lshlrev_b32_e32 v100, 16, v49
	v_and_b32_e32 v103, 0xffff0000, v65
	v_lshlrev_b32_e32 v102, 16, v65
	v_pk_mul_f32 v[100:101], v[100:101], v[102:103]
	v_and_b32_e32 v105, 0xffff0000, v50
	v_lshlrev_b32_e32 v104, 16, v50
	v_and_b32_e32 v107, 0xffff0000, v66
	v_lshlrev_b32_e32 v106, 16, v66
	v_pk_mul_f32 v[104:105], v[104:105], v[106:107]
	v_and_b32_e32 v109, 0xffff0000, v51
	v_lshlrev_b32_e32 v108, 16, v51
	v_and_b32_e32 v111, 0xffff0000, v67
	...
	v_pk_mul_f32 v[116:117], v[116:117], v[106:107]
	v_and_b32_e32 v119, 0xffff0000, v35
	v_lshlrev_b32_e32 v118, 16, v35
	v_pk_mul_f32 v[118:119], v[118:119], v[110:111]
	v_mov_b32_e32 v120, v112
	v_mov_b32_e32 v121, v96
	v_mov_b32_e32 v96, v113
	v_pk_add_f32 v[96:97], v[120:121], v[96:97]
	s_nop 0
	v_pk_add_f32 v[92:93], v[92:93], v[96:97]
	v_mov_b32_e32 v96, v114
	v_mov_b32_e32 v97, v100
	...
	s_nop 0
	v_pk_add_f32 v[92:93], v[92:93], v[96:97]
	v_and_b32_e32 v97, 0xffff0000, v16
	...
	v_pk_mul_f32 v[106:107], v[112:113], v[106:107]
	v_and_b32_e32 v113, 0xffff0000, v7
	v_lshlrev_b32_e32 v112, 16, v7
	v_pk_mul_f32 v[110:111], v[112:113], v[110:111]
	v_mov_b32_e32 v112, v98
	v_mov_b32_e32 v113, v96
	v_mov_b32_e32 v96, v99
	v_pk_add_f32 v[96:97], v[112:113], v[96:97]
...
; %bb.37:                               ;   in Loop: Header=BB2_17 Depth=2
	...
	v_and_b32_e32 v99, 0xffff0000, v60
	v_lshlrev_b32_e32 v98, 16, v60
	v_pk_mul_f32 v[96:97], v[96:97], v[98:99]
	v_and_b32_e32 v101, 0xffff0000, v45
	v_lshlrev_b32_e32 v100, 16, v45
	v_and_b32_e32 v103, 0xffff0000, v61
	v_lshlrev_b32_e32 v102, 16, v61
	v_pk_mul_f32 v[100:101], v[100:101], v[102:103]
	v_and_b32_e32 v105, 0xffff0000, v46
	v_lshlrev_b32_e32 v104, 16, v46
	v_and_b32_e32 v107, 0xffff0000, v62
	v_lshlrev_b32_e32 v106, 16, v62
	v_pk_mul_f32 v[104:105], v[104:105], v[106:107]
...
; COMPUTE_PGM_RSRC3_GFX90A:TG_SPLIT: 0
	...
	.type	__hip_cuid_1fe3ce7ab558a288,@object ; @__hip_cuid_1fe3ce7ab558a288
	.section	.bss,"aw",@nobits
	.globl	__hip_cuid_1fe3ce7ab558a288
__hip_cuid_1fe3ce7ab558a288:
	.byte	0                               ; 0x0
	.size	__hip_cuid_1fe3ce7ab558a288, 1
	...
	.addrsig
	.addrsig_sym __hip_cuid_1fe3ce7ab558a288
	.amdgpu_metadata
---
amdhsa.kernels:
  - .agpr_count:     0
