...
export AITER_LOG_MORE=1 && (pytest ./op_tests/test_batch_prefill.py::test_batch_prefill_with_paged_kv_cache_v2 -v -s -k "19378--5-5--10-10-dtype0-True-0.0-NHD-True-True-16-False-False" > ./log_run/log1 2>&1 && cat ./log_run/log1 | egrep "paged_kv_cache_v2\[|avg_kt_base|PASSED|dump_dir|_ZN7ck_tile|_vllm_layout") > ./log_run/op_mi308_case_list1_ktprof_perf_v2.txt
# export AITER_LOG_MORE=1 && (pytest ./op_tests/test_batch_prefill.py::test_batch_prefill_with_paged_kv_cache_v2 -v -s -k "19378--5-5--10-10-dtype0-True-0.0-NHD-True-True-16-False-False" > ./log_run/log1 2>&1 && cat ./log_run/log1 | egrep "paged_kv_cache_v2\[|avg_kt_base|PASSED|dump_dir|_ZN7ck_tile|_vllm_layout") > ./log_run/op_mi308_case_list1_ktprof_perf_vt.txt
...
(pytest ./op_tests/test_batch_prefill.py::test_batch_prefill_with_paged_kv_cache_v2 -v -s -k "19378--5-5--10-10-dtype0-True-0.0-NHD-True-True-16-False-False" > ./log_run/log1 2>&1 && cat ./log_run/log1 | egrep "paged_kv_cache_v2\[|avg_kt_base|PASSED|dump_dir|_ZN7ck_tile|_vllm_layout") > ./log_run/op_mi308_case_list1_perf_v2.txt
