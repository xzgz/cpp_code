...
def chat_with_deepseek_demo2():
    ...
    deal_with_cpp_file_list = [
        ...
        "/mnt/raid0/heyanguang/code/vllm_fa_batch_prefill/aiter/aiter/jit/build/ck/include/ck_tile/ops/fmha/block/block_masking_hip.hpp",
        "/mnt/raid0/heyanguang/code/vllm_fa_batch_prefill/aiter/aiter/jit/build/ck/include/ck_tile/ops/fmha/pipeline/block_fmha_pipeline_problem_hip.hpp",
        "/mnt/raid0/heyanguang/code/vllm_fa_batch_prefill/aiter/aiter/jit/build/ck/include/ck_tile/ops/fmha/pipeline/block_fmha_batch_prefill_pipeline_qr_ks_vs_async_hip.hpp",
...
# """
    ...
    # print(f"input_prompt.split(' '):\n{input_prompt.split(' ')}")
    print(f"max_background_worlds_count:\n{max_background_worlds_count}")
    print(f"input_prompt_words_count:\n{input_prompt_words_count}")
